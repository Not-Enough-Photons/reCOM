...
CWindow::CWindow(CRdrIO* reader)
{
	...
	zrdr_finduint(window_settings, "width", &m_width, 0);
	zrdr_finduint(window_settings, "height", &m_height, 0);
	...
	if (window_flags_tag)
	{
		for (u32 i = 0; i < window_flags_tag->length; i++)
		{
